...
,      LPAD(CASE 
            ...
            END, 7, ' ' ) "Buffers"
,      TO_CHAR(DECODE(e.db_block_gets - NVL(b.db_block_gets, 0) + e.consistent_gets - NVL(b.consistent_gets, 0), 0, TO_NUMBER(null), (100 * (1 - ((e.physical_reads - NVL(b.physical_reads, 0)) / (e.db_block_gets - NVL(b.db_block_gets, 0) + e.consistent_gets - NVL(b.consistent_gets, 0)))))), '9990.99' ) "Pool Hit%"
