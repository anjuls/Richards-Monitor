...
,    (SELECT NVL(SUM(CASE 
      ...
      ,      DECODE(NVL(SUM(CASE 
                            ...
                            END), '0'), '0', NVL(SUM(CASE 
                                                     ...
                                                     END), '0'), SUM(CASE 
                                                                     ...
                                                                     END)) rec_cache
      ,      DECODE(NVL(SUM(CASE 
                            WHEN name = 'db_cache_size'THEN VALUE
                            ELSE '0'
                            END), '0'), '0', NVL(SUM(CASE 
      ...
      WHERE name IN ('db_2k_cache_size', 'db_4k_cache_size', 'db_8k_cache_size', 'db_16k_cache_size', 'db_32k_cache_size', 'db_cache_size', 'db_block_buffers', 'db_keep_cache_size', 'buffer_pool_keep', 'db_recycle_cache_size', 'buffer_pool_recycle') 
        AND snap_id = ? 
        AND dbid = ? 
